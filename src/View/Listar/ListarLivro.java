...
public class ListarLivro extends javax.swing.JFrame {
    ...
    public void CarregarLista(){
        ...
        DAO.DaoLivro itensLivro = new DaoLivro();
        ResultSet rs = itensLivro.listar();
    ...
    private void initComponents() {
        ...
        JTableLivro.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "Data de Publicação", "Número de Páginas", "Valor Unitário", "Categoria", "", "Editora", ""
            }
        ) {
        ...
        btnAlterar.setText("Alterar Livro");
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if(JTableLivro.getSelectedRow() < 0){
            JOptionPane.showMessageDialog(null, "Selecione uma linha da tabela!");
        }else{
            int linha = JTableLivro.getSelectedRow();
            int id = Integer.parseInt((String) JTableLivro.getValueAt(linha, 0));
            
            DaoLivro delete = new DaoLivro();
            delete.excluir(id);
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if(JTableLivro.getSelectedRow() < 0){
            ...
            String cod, nome, dt_publi, paginas, valor;
            int cat, editora;
            int linha = JTableLivro.getSelectedRow();
            
            cod = (String) JTableLivro.getValueAt(linha, 0);
            nome = (String) JTableLivro.getValueAt(linha, 1);
            dt_publi = (String) JTableLivro.getValueAt(linha, 2);
            paginas = (String) JTableLivro.getValueAt(linha, 3);
            valor = (String) JTableLivro.getValueAt(linha, 4);
            cat = Integer.parseInt((String) JTableLivro.getValueAt(linha, 6));
            editora = Integer.parseInt((String) JTableLivro.getValueAt(linha, 8));
            
            Alt_Livros alterar = new Alt_Livros();
            alterar.buscar(cod, nome, dt_publi, paginas, valor, cat, editora);
